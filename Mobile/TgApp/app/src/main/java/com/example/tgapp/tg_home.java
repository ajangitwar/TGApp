...
import static com.example.tgapp.R.id.mtrl_internal_children_alpha_tag;
import static com.example.tgapp.R.id.nav_profile;
import static com.example.tgapp.R.id.nav_stdlist;
...
public class tg_home extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tg_home);
...
//        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.tg_home, menu);
        return true;
    }
...
//        }
        ...
        if (fragment != null){
            ...
            ft.replace(R.id.content_tg_home,fragment);
