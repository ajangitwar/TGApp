      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top " id="navigation-example">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" id="prof1" href="javascript:void(0)">Teacher</a>
          </div>
          ...
          <div class="row">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">*fill required details</p>
                </div>
                <div class="card-body">
                  <form action="dbaddteacher.php" method="POST">
                    <!-- <div class="row">
                      <div class="col-md-5">
                   ...
                   <!--  <div class="row">
                    ...
                    <button type="submit" name ="submit" class="btn btn-primary pull-right">Add Profile</button>
