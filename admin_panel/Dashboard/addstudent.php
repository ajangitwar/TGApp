                ...
                <div class="card-body">
                  <form action="dbaddstudent.php" method="POST">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Student Roll No.</label>
                    ...
                    <button type="submit" class="btn btn-primary pull-right" name="submit">Add Profile</button>
